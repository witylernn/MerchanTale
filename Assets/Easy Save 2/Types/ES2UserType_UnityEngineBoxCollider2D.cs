...
writer.Write(data.edgeRadius);
writer.Write(data.autoTiling);
writer.Write(data.density);
writer.Write(data.isTrigger);
writer.Write(data.usedByEffector);
writer.Write(data.usedByComposite);
...
data.edgeRadius = reader.Read<System.Single>();
data.autoTiling = reader.Read<System.Boolean>();
...
data.usedByComposite = reader.Read<System.Boolean>();
